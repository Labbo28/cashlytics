...
import it.uniroma3.cashlytics.cashlytics.Repository.TransactionRepository;
...
public class TransactionService {
     ...
     * - Se dto.getCategoryId() è valorizzato, recupera quella categoria per l'utente.
     * - Altrimenti, se dto.getCategoryName() non è vuoto, cerca o crea la categoria.
     ...
     *
     * @param transactionDTO dati dal form (importo, tipo, descrizione, categoryId/name, merchantId/name)
     * @param account l'account finanziario a cui associare la transazione
     * @param user l'utente corrente (proprietario di account, category e merchant)
     * @param bindingResult per segnalare eventuali errori di validazione su category/merchant
    ...
    public Transaction createTransaction(
        ...
        // 3. Se ci sono errori di binding (invalid category/merchant), interrompi e ritorna null
