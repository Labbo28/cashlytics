...
import it.uniroma3.cashlytics.cashlytics.service.CategoryService;
import it.uniroma3.cashlytics.cashlytics.service.FinancialAccountService;
import it.uniroma3.cashlytics.cashlytics.service.MerchantService;
...
public class FinancialAccountController {
     ...
     * in caso negativo o se non autenticato, imposta un messaggio di errore e ritorna null.
     */
    ...
    /**
     * Restituisce la lista degli enum TransactionType oppure valori base se non esiste l'enum.
     */
    private List<Object> loadTransactionTypes() {
        try {
            Class<?> transactionTypeClass =
                Class.forName("it.uniroma3.cashlytics.cashlytics.Model.Enums.TransactionType");
